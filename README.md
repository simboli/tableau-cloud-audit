...
- **No hidden logic.** The collector extracts and stores — it computes nothing about
  ...
  [docs/api-coverage.md](docs/api-coverage.md), and the complete definition of "what
  counts as personal data" lives in one reviewable file:
  [`src/tca/pseudo/manifest.py`](src/tca/pseudo/manifest.py).
